...
void sendData(int co2, float temp, float hum) {
  ...
  if (client) {
...

    {
      ...
      if (https.begin(*client, observatory_url.c_str())) {  // HTTPS
        ...
        String body = "{ \"bucket\": \"co2-sensor-living-room\", \"payload\": { \"co2\": " + String(co2) + ", \"temperature\": " + String(temp) + ", \"humidity\": " + String(hum) + " } }";
